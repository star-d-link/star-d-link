...
public class GroupPostController {
    ...
    @DeleteMapping("/{group-id}/post/{post-id}")
    public ResponseEntity<?> deletePost(/*시큐리티 객체 받기*/@PathVariable("group-id") Long groupId,
        @PathVariable("post-id") Long postId) {
        groupPostService.delete(groupId, postId);
        ResponseDto<?> responseDto = ResponseDto.onSuccess("스터디 그룹 게시글을 성공적으로 삭제하였습니다.", null);
        return ResponseEntity.ok(responseDto);
    }
}
